...
export const UserProvider = ({ children }) => {
  ...
  const isUserOnline = useCallback((userIdOrUser) => {
    ...
    // Considerar en línea únicamente si su última actividad/latido fue en los últimos 90 segundos (90s)
    return (Date.now() - mostRecent) < 90000;
  ...
  const acceptFamilyInvitation = (invitationId) => {
    ...
    const newMatch = {
      ...
      assignedColor: 'black',
      timeControl: (inv.timeControl !== undefined && inv.timeControl !== null) ? inv.timeControl : 300,
      gameVariant: inv.gameVariant || 'standard',
      handicapConfig: inv.handicapConfig || null,
