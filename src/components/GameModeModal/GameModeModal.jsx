...
import { 
  ...
  ArrowRight, ArrowLeft, GraduationCap, Trophy, ChevronRight 
} from 'lucide-react';
                ...
                {popularVariants.map((variant) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      className="btn-secondary"
                      style={{ width: '100%', padding: '6px', fontSize: '0.76rem', justifyContent: 'center', color: variant.borderColor, borderColor: variant.borderColor }}
                      onClick={(e) => {
                        e.stopPropagation();
