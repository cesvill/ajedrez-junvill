...
export const renderAvatarBackground = (cfg) => {
  switch (cfg.background) {
    ...
    case 'parchment_wood':
      return (
        <circle key="bg" cx="50" cy="50" r="48" fill="#fef3c7" stroke="#b45309" strokeWidth="2.5" />
      );
    case 'royal_castle':
      return (
        <circle key="bg" cx="50" cy="50" r="48" fill="#fae8ff" stroke="#9333ea" strokeWidth="2.5" />
      );
    case 'blue_sky':
    default:
      return (
        <circle key="bg" cx="50" cy="50" r="48" fill="#e0f2fe" stroke="#0284c7" strokeWidth="2.5" />
      );
  }
};

// Renderizador de Vestimenta Superior (Busto)
export const renderAvatarShirt = (cfg) => {
  switch (cfg.shirtStyle) {
    ...
    case 'blazer':
      return (
        <g key="shirt">
          <path d="M 20,95 Q 50,70 80,95 Z" fill={cfg.shirtColor} />
          <polygon points="50,73 40,95 60,95" fill="#f8fafc" />
...
export const renderAvatarFace = (cfg) => {
  return (
    <g key="face">
      {/* Cuello y Cabeza */}
...
export const renderAvatarHair = (cfg) => {
  switch (cfg.hairStyle) {
    case 'short':
      return (
        <path key="hair" d="M 26,44 Q 30,22 50,22 Q 70,22 74,44 Q 65,30 50,30 Q 35,30 26,44 Z" fill={cfg.hairColor} />
      );
    case 'ponytail':
      return (
        <g key="hair">
    ...
    case 'afro':
      return (
        <circle key="hair" cx="50" cy="44" r="28" fill={cfg.hairColor} />
      );
    case 'bun':
      return (
        <g key="hair" fill={cfg.hairColor}>
    ...
    case 'crest':
      return (
        <path key="hair" d="M 44,40 L 50,14 L 56,40 Z" fill={cfg.hairColor} />
      );
    case 'bald_senior':
      return (
        <path key="hair" d="M 24,48 Q 20,32 35,26 Q 65,26 76,32 Q 78,48 76,48" fill="none" stroke="#cbd5e1" strokeWidth="5" strokeLinecap="round" />
      );
    case 'long':
      return (
        <g key="hair" fill={cfg.hairColor}>
    ...
    default:
      return (
        <path key="hair" d="M 24,44 Q 30,16 55,20 Q 76,18 76,42 Q 62,28 24,44 Z" fill={cfg.hairColor} />
      );
  }
};

// Renderizador de Accesorios y Sombreros
export const renderAvatarAccessory = (cfg) => {
  switch (cfg.accessory) {
    ...
    case 'headband':
      return (
        <path key="acc" d="M 26,36 Q 50,30 74,36" fill="none" stroke="#f59e0b" strokeWidth="4" strokeLinecap="round" />
      );
    case 'monocle':
      return (
        <g key="acc">
...
export const DynamicAvatar = ({ config = DEFAULT_AVATAR_CONFIG, size = 64, className = "" }) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 100 100" className={className} style={{ display: 'inline-block', verticalAlign: 'middle' }}>
      {renderAvatarBackground(cfg)}
      {renderAvatarShirt(cfg)}
