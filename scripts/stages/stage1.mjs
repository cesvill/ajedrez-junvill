export function getStage1(ex, th) {
  return {
    id: 'etapa-1-basicos',
    ...
    lessons: [
      {
        ...
        steps: [
          th('El Ejército del Tablero', 'Cada pieza tiene su propio superpoder de movimiento: el Peón avanza hacia el frente, el Caballo salta en "L", el Alfil recorre diagonales, la Torre domina filas y columnas, y la Dama combina el poder de la Torre y el Alfil.', 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1'),
          ex('ex_1', 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1', 'e2', 'e4', 'Paso 1: Mueve tu peón de rey dos casillas al centro (de e2 a e4).', 'Avanza el peón a e4.', '¡Excelente! Controlas las casillas centrales d5 y f5.'),
          ex('ex_2', 'rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2', 'g1', 'f3', 'Paso 2: Desarrolla tu Caballo en salto en "L" de g1 a f3.', 'Salta con el caballo a f3.', '¡Gran salto en "L"! El caballo ataca el centro y prepara el enroque.'),
          ex('ex_3', 'rnbqkbnr/pppppppp/8/8/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 1 3', 'f1', 'c4', 'Paso 3: Desarrolla tu Alfil en diagonal de f1 a c4 apuntando al rey enemigo.', 'Lleva tu alfil a c4.', '¡Brillante! El alfil controla la gran diagonal a2-g8.'),
          ...
          ex('ex_5', '4k3/8/8/8/8/8/4Q3/4K3 w - - 0 1', 'e2', 'e4', 'Paso 5: Centraliza tu Dama (la pieza más poderosa) moviéndola de e2 a e4.', 'Mueve tu dama de e2 a e4.', '¡Ataque demoledor! La dama combina el movimiento de la Torre y el Alfil en todas las direcciones.')
        ]
      },
      {
        id: 'l02_capturas',
      ...
      },
      {
        ...
        category: 'tactica',
        steps: [
          th('Piezas en el Aire (Colgadas)', 'Una pieza desprotegida no tiene defensores aliados que la cuiden. Siempre debes estar atento para capturarlas totalmente gratis.', 'r1bqkbnr/pppp1ppp/8/4n3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 0 1'),
          ex('ex_1', 'r1bqkbnr/pppp1ppp/8/4n3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 0 1', 'f3', 'e5', 'Paso 1: El caballo negro en e5 saltó al centro y no tiene defensores (está colgado). Captúralo con tu Caballo de f3.', 'Salta de f3 a e5 capturando el caballo desprotegido.', '¡Caballo gratis! Al no tener defensores, ganas 3 puntos limpios sin que el rival pueda recapturar.'),
          ex('ex_2', 'r1bqk1nr/pppp1ppp/2n5/4p3/4P2b/5N2/PPPP1PPP/RNBQKB1R w KQkq - 1 3', 'f3', 'h4', 'Paso 2: Las negras dejaron su Alfil en h4 completamente solo e indefenso. Captúralo con tu Caballo de f3.', 'Mueve tu caballo de f3 a h4 capturando el alfil colgado.', '¡Alfil capturado gratis! Has eliminado la pieza desprotegida.'),
          ex('ex_3', 'r3k3/8/8/8/4B3/8/8/4K3 w - - 0 1', 'e4', 'a8', 'Paso 3: La torre negra en a8 está olvidada en la esquina sin defensores. Captúrala con tu Alfil en diagonal.', 'Desliza tu alfil de e4 a a8 capturando la torre desprotegida.', '¡Torre limpia de 5 puntos! Gran visión de piezas colgadas.'),
          ex('ex_4', '4k3/8/8/8/1b6/P7/8/4K3 w - - 0 1', 'a3', 'b4', 'Paso 4: El alfil negro en b4 está desprotegido. Captúralo con tu peón de a3.', 'Captura en diagonal el alfil de b4 con tu peón en a3.', '¡Ganancia de pieza colgada! Tu peón de 1 punto se come un alfil de 3 puntos gratis.'),
          ex('ex_5', 'r1b1kbnr/pppp1ppp/8/3q4/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 0 1', 'c3', 'd5', 'Paso 5: Las negras sacaron su Dama a d5 prematuramente y nadie la defiende. ¡Captura la Dama con tu Caballo en c3 o con tu peón de e4!', 'Captura la dama en d5 con tu caballo o con tu peón.', '¡Dama de 9 puntos gratis! Lección dominada: siempre castiga las piezas desprotegidas.', {
            alternativeSolutions: [
              { from: 'e4', to: 'd5', feedback: '¡Excelente captura con el peón! Matar la Dama en d5 con tu peón (exd5) es totalmente ganador y te da una ventaja colosal (+9 puntos).' }
            ]
          })
        ]
      },
      {
        ...
        category: 'tactica',
        steps: [
          th('La Escala de Valor y los Intercambios', 'Cada pieza tiene un valor relativo:\n• Peón = 1 punto\n• Caballo = 3 puntos\n• Alfil = 3 puntos\n• Torre = 5 puntos\n• Dama = 9 puntos\n• Rey = ¡Infinito!\n\nEn ajedrez siempre vale la pena sacrificar una pieza de menor valor para capturar una de mayor valor (por ejemplo: entregar un peón de 1 pt o un alfil de 3 pts para capturar una Dama de 9 pts o una Torre de 5 pts).', 'r1b1kbnr/p1pp1ppp/1p6/1p1q4/8/2N5/PPPPPPPP/R1BQKBNR w KQkq - 0 1'),
          ex('ex_1', 'r1b1kbnr/p1pp1ppp/1p6/1p1q4/8/2N5/PPPPPPPP/R1BQKBNR w KQkq - 0 1', 'c3', 'd5', 'Paso 1 (Elegir la pieza más valiosa): Tu Caballo (3 pts) puede capturar el peón en b5 (1 pt) o la Dama en d5 (9 pts). ¡Decide capturar la pieza más valiosa!', 'Captura la Dama en d5 con tu caballo.', '¡Decisión magistral! Capturar la Dama te otorga +9 puntos en vez de solo 1 punto del peón.', {
            incorrectFeedback: {
          ...
          ex('ex_2', 'r1b1kbnr/ppp2ppp/3p4/4q3/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 0 1', 'd4', 'e5', 'Paso 2 (Sacrificio favorable: Peón por Dama): La Dama negra en e5 está defendida por su peón de d6. Sacrifica tu peón de d4 (1 pt) capturando la Dama (9 pts) sabiendo que el peón negro te recapturará.', 'Captura la Dama en e5 con tu peón.', '¡Intercambio super favorable! Aunque el peón negro de d6 recaptura en e5 (dxe5), ganaste una Dama de 9 puntos entregando solo 1 peón (+8 de ganancia neta).'),
          ex('ex_3', '5rk1/5rpp/8/8/2B5/8/4PPPP/4K2R w K - 0 1', 'c4', 'f7', 'Paso 3 (Ganancia de Calidad: Alfil por Torre): Entrega tu Alfil de c4 (3 pts) para capturar la Torre enemiga en f7 (5 pts).', 'Captura la torre en f7 con tu alfil.', '¡Ganancia de calidad (+2 pts)! Entregar una pieza menor (3 pts) a cambio de una Torre (5 pts) es una ventaja táctica excelente.'),
          ex('ex_4', '3qkb1r/4pppp/8/8/8/8/3R4/4K2R w Kk - 0 1', 'd2', 'd8', 'Paso 4 (Sacrificio de Pieza Mayor: Torre por Dama): Sacrifica tu Torre en d2 (5 pts) para devorar la Dama rival en d8 (9 pts).', 'Avanza por la columna hasta d8 capturando la Dama.', '¡Sacrificio rentable (+4 pts)! Entregas 5 puntos para arrebatar la pieza más temible del adversario.'),
          ex('ex_5', 'r1b1kbnr/ppp2ppp/3p4/2n1q3/3P4/8/PPP1PPPP/RNBQKBNR w KQkq - 0 1', 'd4', 'e5', 'Paso 5 (Doble ataque: elegir el botín supremo): Tu peón en d4 ataca tanto al Caballo en c5 (3 pts) como a la Dama en e5 (9 pts), ambos defendidos por el peón de d6. ¡Decide capturar la pieza de mayor valor!', 'Captura la Dama en e5 con tu peón.', '¡Maestría en la escala de valores! Capturaste la Dama (9 pts) logrando +8 pts netos en lugar del caballo (+2 pts netos).', {
            incorrectFeedback: {
      ...
      },
      {
        ...
        category: 'estrategia',
        steps: [
          th('La Gran Transformación', 'Cuando un peón llega a la última fila con el apoyo de tus piezas, corona inmediatamente en Dama protegida para asegurar la victoria.', '3k4/4P3/8/8/8/8/4R3/4K3 w - - 0 1'),
          ex('ex_1', '3k4/4P3/8/8/8/8/4R3/4K3 w - - 0 1', 'e7', 'e8', 'Paso 1: Tu peón en e7 avanza a e8 para coronar en Dama protegida por tu Torre de e2.', 'Mueve el peón a e8 y corona en Dama.', '¡Corona en Dama protegida! Tu torre de e2 defiende a la nueva Dama, por lo que el rey negro no puede capturarla.', 'q'),
          ex('ex_2', '1k6/P7/8/8/8/8/R7/4K3 w - - 0 1', 'a7', 'a8', 'Paso 2: Corona tu peón de a7 a a8 en Dama con el respaldo de tu Torre en a2.', 'Avanza a a8 coronando en Dama.', '¡Excelente coronación protegida! La nueva Dama está defendida y el rey negro no puede tocarla.', 'q'),
          ex('ex_3', 'k7/1PK5/8/8/8/8/8/8 w - - 0 1', 'b7', 'b8', 'Paso 3: Corona tu peón en b8 con Jaque Mate asistido por tu Rey en c7.', 'Corona en b8 transformando el peón en Dama.', '¡Coronación con Jaque Mate! El rey negro está acorralado y la Dama está blindada por el rey.', 'q'),
          ex('ex_4', '6k1/7P/8/8/8/8/7R/4K3 w - - 0 1', 'h7', 'h8', 'Paso 4: Corona tu peón de h7 a h8 obteniendo una Dama defendida por tu Torre en h2.', 'Mueve a h8 y corona en Dama.', '¡Brillante! Peón coronado, defendido y posición totalmente ganada.', 'q'),
          ex('ex_5', '4k3/3r4/8/8/8/8/3p4/4K3 b - - 0 1', 'd2', 'd1', 'Paso 5: Juegas con negras. Corona tu peón en d1 con jaque defendido por tu Torre en d7.', 'Mueve el peón negro a d1 coronando en Dama.', '¡Gran coronación con negras! Tu Dama en d1 está blindada por tu torre en d7.', 'q')
        ]
      },
      {
        id: 'l06_jaque',
        ...
        category: 'tactica',
        steps: [
          th('Amenaza al Monarca', 'Un jaque ocurre cuando una de tus piezas ataca directamente la casilla donde se encuentra el Rey rival a distancia segura.', '4k3/8/8/8/8/8/4Q3/4K3 w - - 0 1'),
          ex('ex_1', '4k3/8/8/8/8/8/4Q3/4K3 w - - 0 1', 'e2', 'e4', 'Paso 1 (Jaque a Distancia con Dama): Lleva tu Dama a e4 para dar jaque directo al rey por la columna "e".', 'Mueve tu dama a e4 dando jaque vertical.', '¡Jaque vertical seguro! La dama ataca al rey a 4 casillas de distancia.'),
          ...
          ex('ex_3', '4k3/8/8/8/2B5/8/8/4K3 w - - 0 1', 'c4', 'b5', 'Paso 3 (Jaque con Alfil): Lleva tu Alfil a b5 dando jaque en diagonal desde una distancia segura.', 'Mueve tu alfil de c4 a b5.', '¡Jaque diagonal seguro! El alfil apunta al rey sin ponerse a tiro de captura.'),
          ex('ex_4', '4k3/8/8/8/4N3/8/8/4K3 w - - 0 1', 'e4', 'd6', 'Paso 4 (Jaque con Caballo): Salta con tu Caballo de e4 a d6 para asestar un jaque directo al Rey en e8.', 'Salta con tu caballo de e4 a d6.', '¡Jaque de Caballo legítimo! Un ataque sorpresivo en "L" que no se puede bloquear.'),
          ex('ex_5', '4k3/8/3P4/8/8/8/8/4K3 w - - 0 1', 'd6', 'd7', 'Paso 5 (Jaque con Peón): Avanza tu peón de d6 a d7 atacando directamente al Rey negro en diagonal.', 'Avanza tu peón a d7.', '¡Jaque con peón! Incluso la pieza más modesta pone en jaque directo al rey.')
        ]
      },
      {
        ...
        category: 'tactica',
        steps: [
          th('La Regla de Oro: C - I - M', 'Para escapar de un jaque sólo existen 3 formas: 1. C = Capturar la pieza atacante, 2. I = Interponer una pieza entre el atacante y el rey, 3. M = Mover el Rey a una casilla segura.', '4k3/4r3/8/8/8/8/4Q3/2K5 b - - 0 1'),
          ex('ex_1', '4k3/4r3/8/8/8/8/4Q3/2K5 b - - 0 1', 'e7', 'e2', 'Paso 1 (C = Capturar): La Dama blanca en e2 te da jaque. ¡Captúrala gratis con tu Torre en e7!', 'Captura la dama en e2 con tu torre.', '¡Excelente! Capturar la pieza atacante elimina el peligro ganando la Dama rival (+9 pts).'),
          ...
          ex('ex_4', 'r1bqk2r/pppp1Qpp/2n5/4p3/4P3/8/PPPP1PPP/RNB1K1NR b KQkq - 0 1', 'e8', 'f7', 'Paso 4 (C = Capturar): La Dama desprotegida en f7 da jaque al rey. Captúrala directamente con tu Rey de e8 a f7.', 'Captura la dama con tu rey en f7.', '¡Dama neutralizada! Tu rey eliminó personalmente la amenaza.'),
      ...
      },
      {
        ...
        steps: [
          ...
          ex('ex_3', '7k/5p1p/5N2/8/8/8/8/4K1R1 w - - 0 1', 'g1', 'g8', 'Paso 3 (Mate Árabe): El Caballo en f6 apoya a la Torre. Lleva tu Torre de g1 a g8 dando Jaque Mate.', 'Lleva tu torre a g8.', '¡Jaque Mate Árabe! Coordinación perfecta entre Torre y Caballo.'),
          ex('ex_4', 'k7/8/1K6/8/8/8/8/7R w - - 0 1', 'h1', 'h8', 'Paso 4 (Mate con Torre y Rey): El rey negro está arrinconado en a8. Lleva tu Torre de h1 a h8 dando Jaque Mate.', 'Mueve tu torre a h8.', '¡Jaque Mate! El rey blanco corta todas las casillas de escape.'),
          ex('ex_5', '6k1/5ppp/8/8/8/8/8/4R1K1 w - - 0 1', 'e1', 'e8', 'Paso 5: Asesta el golpe definitivo llevando tu Torre a la octava fila dando Jaque Mate.', 'Mueve tu torre a e8 dando mate.', '¡Victoria total! Has completado con éxito 5 patrones esenciales de mate en 1.')
        ]
      },
      {
        id: 'l09_rey_ahogado',
      ...
      },
      {
        ...
        steps: [
          ...
          ex('ex_1', '4k3/8/8/8/8/8/4Q3/4K3 w - - 0 1', 'e2', 'e6', 'Paso 1: Coloca tu Dama a salto de caballo en e6 para acorralar al rey rival en la 8ª fila.', 'Mueve tu dama a e6.', '¡Caja reducida con seguridad! La dama corta la 7ª fila sin exponerse.'),
          ...
          ex('ex_5', '4k3/Q7/4K3/8/8/8/8/8 w - - 0 1', 'a7', 'e7', 'Paso 5: Asesta el Jaque Mate definitivo (el Beso de la Muerte) con tu Dama en e7 defendida por tu Rey.', 'Mueve tu dama a e7 dando mate.', '¡Jaque Mate perfecto! Técnica de Dama y Rey dominada.')
        ]
      },
      {
      ...
      },
      {
        ...
        steps: [
          ...
          ex('ex_5', '4k3/7r/8/8/8/2B5/8/4K3 w - - 0 1', 'c3', 'h8', 'Paso 5: La torre negra en h8 está en la diagonal de tu Alfil. Captúrala en h8.', 'Captura en h8 con tu alfil.', '¡Clavadas dominadas al máximo!')
        ]
      },
      {
      ...
      },
      {
        ...
        category: 'tactica',
        steps: [
          th('El Salto Mortal', 'El Caballo es el rey de las horquillas porque ataca en 8 casillas diferentes saltando por encima de las piezas sin poder ser bloqueado.', 'r3k2r/ppp2ppp/2n5/3N4/8/8/PPP2PPP/R3K2R w KQkq - 0 1'),
          ex('ex_1', 'r3k2r/ppp2ppp/2n5/3N4/8/8/PPP2PPP/R3K2R w KQkq - 0 1', 'd5', 'c7', 'Paso 1: Salta a c7 con tu Caballo haciendo horquilla sobre el Rey en e8 y la Torre en a8.', 'Lleva tu caballo a c7.', '¡Doble Real seguro! Jaque al rey y captura de torre garantizada sin que nadie te capture.'),
          ex('ex_2', 'r3k2r/ppp2ppp/8/3N4/8/8/PPP2PPP/R3K2R w KQkq - 0 1', 'd5', 'c7', 'Paso 2: Repite la horquilla en c7 amenazando al rey y la torre.', 'Lleva tu caballo a c7.', '¡Doble Real! Jaque al rey y captura de torre garantizada.'),
          ex('ex_3', 'r3k2r/ppp2ppp/2n5/8/4N3/8/PPP2PPP/R3K2R w KQkq - 0 1', 'e4', 'c5', 'Paso 3: Centraliza tu Caballo a c5 atacando el flanco de dama.', 'Mueve tu caballo a c5.', '¡Caballo central dominante!'),
          ex('ex_4', '4k3/8/8/2N5/8/8/5K2/7r w - - 0 1', 'c5', 'e4', 'Paso 4: Centraliza tu Caballo a e4.', 'Mueve tu caballo a e4.', '¡Caballo central activo!'),
